...
- Custom groups and playlist organization
- Advanced player settings for buffering, audio, subtitles, and display
- Multi-profile support
- Premium features for advanced organization, sync, and customization
...
2. Import your playlist using the method that fits your provider:
   ...
   - Backup restore
   - Cloud sync
   - Remote activation via MAC
3. Wait for the initial content processing to finish.
4. If some content is missing after import, run a manual update from `Settings > Playlist and update`.
...
N.B:During the free trial, Cloud Sync and Backup / Restore are not active.
